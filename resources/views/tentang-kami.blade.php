...
<section style="padding-top: 72px; padding-bottom: 80px; border-bottom: 0.5px solid rgba(76,69,70,0.3); background-color: #131313; position: relative; overflow: hidden;" class="bg-grid-lg page-padding">
    <div style="width: 100%;">
        <!-- 2-column hero: text left, video strictly on right side -->
        <div style="display: flex; flex-direction: row; gap: 48px; align-items: flex-start; justify-content: space-between; flex-wrap: wrap;">

            <!-- Left: Headline + Text -->
            <div class="reveal" style="flex: 1 1 320px; min-width: 280px; z-index: 10; position: relative; padding-top: 8px;">
                <h1 style="font-family: 'Inter', sans-serif; font-size: clamp(32px, 4.5vw, 68px); line-height: 1.05; letter-spacing: -0.04em; font-weight: 700; color: #e5e2e1; margin-bottom: 20px;">
                    {{ $settings['about_hero_title'] ?? 'Presisi Dalam Praktik.' }}
                </h1>
                <p style="font-family: 'Inter', sans-serif; font-size: 15px; line-height: 25px; color: #cfc4c5; max-width: 480px;">
            ...
            <!-- Right: Video Panel (Vertical 3/4 Panel on Right Side) -->
            <div class="reveal" style="flex: 0 0 360px; max-width: 380px; width: 100%; transition-delay: 200ms; z-index: 10; position: relative;">
